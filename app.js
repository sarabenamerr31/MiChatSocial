// app.js - SERVIDOR BLINDADO CON SEGURIDAD HELMET Y RATE LIMITING

const express = require('express');
const helmet = require('helmet'); // Para seguridad de cabeceras
const rateLimit = require('express-rate-limit'); // Para Anti-DDoS
const app = express();
...
// ----------------------------------------------------
// VARIABLES VITALES (SEGURIDAD Y ENTORNO)
// ----------------------------------------------------
...
// Configuración Anti-DDoS (Permite 100 peticiones por usuario cada 15 minutos)
const limiter = rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutos
    max: 100, // Limita cada IP a 100 solicitudes (conexiones o mensajes rápidos)
...
// ----------------------------------------------------
app.use(helmet()); 
app.use(limiter); // Aplica el límite de velocidad a todas las peticiones
